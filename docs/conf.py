...
#
# pyiiif documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'pyiiif.tex', 'pyiiif Documentation',
...
man_pages = [
    (master_doc, 'pyiiif', 'pyiiif Documentation',
     [author], 1)
]
